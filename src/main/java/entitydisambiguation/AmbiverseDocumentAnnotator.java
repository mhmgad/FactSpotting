...
//        System.out.println(output.getMatches());
        ...
        for (Match match:output.getMatches()       ) {
            ...
            em.setEntity(new entitydisambiguation.Entity(match.getEntity().getId(),match.getEntity().getScore()));         // ID of the linked entity, e.g. "YAGO3:<The_Who>".
            em.setConfidence(match.getEntity().getScore());    // Confidence score.
            doc.addEntityMention(em);
        }
    }
